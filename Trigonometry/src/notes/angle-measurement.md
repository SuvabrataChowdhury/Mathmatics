...
> One degree is $\frac{1}{360}^{th}$ of a full rotation of a circle. It's denoted by symbol $^\circ$.

Though, this is also a general enough definition for an angle of measurement, it has it's limitations. One of the major limitation being, by definition, a degree as a measurement of angle, can not be more than $360^\circ$ which is a desired property to accurately describe rotation.
...
$$\boxed{1^\circ = \frac{2 \pi }{360} \\; Rad = \frac{\pi}{180} \\; Rad}$$
